...
int main()
{
    ...
    int jumlah,hasil1,hasil2,hasil3,hasil4,hasil5,hasil6,hasil7;
    
    cout<<"                         __ALWAN ROFIQI__"<<endl;
    cout<<"                         __21091397020__"<<endl;
	...
	//total weight yang harus ditempuh
